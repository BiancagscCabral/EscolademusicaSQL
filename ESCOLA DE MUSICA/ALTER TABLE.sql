...
-- Adicionar chave estrangeira na tabela Instrumentos
ALTER TABLE Instrumentos 
ADD COLUMN id_tipo INT AFTER `desc`,
ADD CONSTRAINT fk_instrumento_tipo 
FOREIGN KEY (id_tipo) REFERENCES TipoInstrumento(id_tipo);
